...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/melvitax/DateHelper.git", from: "4.3.0"),
        .package(url: "https://github.com/Prince2k3/Alamofire.git", .branch("websocket"))
    ],
    targets: [
        ...
        .target(
            name: "UIKitAdditions",
            dependencies: ["PromiseKit", "DataSource", "SwiftAdditions", "PhoneNumberKit", "DateHelper", "Alamofire"]),
        .testTarget(
